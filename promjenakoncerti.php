...
if($_POST){
	$izraz = $veza -> prepare("update koncert set naziv=:naziv, datum=:datum, mjesto=:mjesto, opis=:opis where sifra=:sifra");	
	$izraz -> execute($_POST);
				...
				<div class="panel">
					<form action="<?php echo $_SERVER["PHP_SELF"] ?>" method="POST">
						...
						<label for="naziv">naziv</label>
								...
								name="naziv" value="<?php echo $objekt->naziv ?>" />
							...
							<label for="datum">datum</label>
								...
								name="mjesto"  value="<?php echo $objekt->mjesto ?>"/>
								
								<label for="opis">opis</label>
								<input type="text" id="opis"
								name="opis"  value="<?php echo $objekt->opis ?>"/>
								

							<div class="row">
								<div class="large-6 medium-6 small-6 columns end">
									<a href="index.php" class="small button">Odustani</a>
								</div>
